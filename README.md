Com base no template abaixo, carregue dinamicamente dados de produtos (id, nome, imagem e preço),  na lista de cards na página a partir de um arquivo JSON no servidor (JSON-Server). 
